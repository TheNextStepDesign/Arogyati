    ...
    <footer id="Contact" className=" bg-[#393939] text-center text-white">
      <div className="w-[90%] md:w-[70%] 2xl:w-[1440px] m-auto">
        ...
        <div className="flex justify-center flex-col md:flex-row gap-5  md:gap-0 py-5">
          <div className="w-full md:w-1/2 flex flex-col justify-evenly  gap-5 ">
          ...
          <div className=" w-full  flex flex-col-reverse  md:flex-col  justify-between items-end gap-4   ">
            <div className="w-full md:w-[83%] p-2" >
