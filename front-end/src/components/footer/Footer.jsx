...
export default function Footer() {
  return (
    <footer className=" bg-[#393939]  text-white">
      <div
        className={`w-[${mobileWidth}] lg:w-[${laptopWidth}] 2xl:w-[${monitorWidth}] m-auto`}
      >
        <div className="flex justify-center flex-col md:flex-row gap-5  md:gap-0 py-5">
          ...
          <div className=" w-full  flex flex-col-reverse  md:flex-col  justify-between items-end  ">
            <div className="w-full 2xl:w-[90%] p-2">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d477.68998944715736!2d74.23125356848838!3d16.700890609736362!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc100403fffffff%3A0xa9245c61bc097f7e!2sInstitute%20Of%20Physiotherapy%20%26%20Rehablitation!5e0!3m2!1sen!2sin!4v1718180852649!5m2!1sen!2sin"
                className="w-full"
                allowfullscreen=""
                loading="lazy"
