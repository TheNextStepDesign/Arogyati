...
const FrontPoster = () => {
  return (
    <div>
        <div className={`md:bg-[url("https://res.cloudinary.com/dw3xsfb9z/image/upload/v1723292117/Hero_BG_awvimi.png")] bg-cover bg-center md:h-[750px] bg-[#b6c480]  w-full py-10 md:py-0`}>
